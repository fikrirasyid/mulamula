 ...
 * Register customizer
 */
function mulamula_customizer_register( $wp_customize ){
...
add_action( 'customize_register', 'mulamula_customizer_register' );

/**
 * Customizer CSS
 */
function mulamula_customize_css(){
	$site_color = get_theme_mod( 'site_color' );
	$site_color_darker = mulamula_adjust_brightness( get_theme_mod( 'site_color' ), -50 );
...
add_action( 'wp_head', 'mulamula_customize_css' );

/**
 * Create slightly darker hexacode color
 * Adopted from Torkil Johnsen's Stack Overflow answer: http://stackoverflow.com/a/11951022
 */
function mulamula_adjust_brightness($hex, $steps) {
